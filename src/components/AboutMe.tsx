    ...
    return (
        <section id='about'>
            <span className={styles.aboutMe}>
                <div className={styles.imageDesktop} role='interest-image'><Image src={require(`/public/images/${interest}.jpg`)} alt='selected image'/></div>
                ...
                <div className={styles.description}>
                    ...
                    <div className={styles.contactInfo} role='contact-info'>
                ...
                <div className={styles.interests}>
                    ...
                    <div className={styles.actionButtons} role='interest-buttons'>
